...
class Kelas extends Operator_Controller
{
	...
	{
        $gejalaa    = $this->kelas->orderBy('id')->getAll();
	...
	{
        $kelas = $this->kelas->where('id', $id)->get();
        if (!$kelas) {
        ...
        if ($this->kelas->where('id', $id)->update($input)) {
	...
	public function delete($id = null)
	{
        ...
        if ($this->kelas->where('id', $id)->delete()) {
    ...
    */
    ...
    public function nama_gejala_unik()
    {
        ...
        $this->kelas->where('nama_gejala', $nama_gejala);
        !$id || $this->kelas->where('id !=', $id);
